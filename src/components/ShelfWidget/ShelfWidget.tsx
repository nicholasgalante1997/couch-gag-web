  ...
  return (
    <div className={ShelfWidgetClassNames.Wrapper}>
      <div className={ShelfWidgetClassNames.CreateSection}>
        ...
        <p>It's a place where you can keep your favorite stories, share your thoughts on different pieces, and direct friends to, to see all that you've done. Set up is way easier than Ikea would have you believe.</p>
